      ...
      <section class="container">
        <h1 id="logo">
          <a href="#" title="MindSchool">
            <img src="~/assets/img/logo.png" width="100%" alt="MindSchool" />
          </a>
        </h1>
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="#" title="五道口职业技术学院" target="_blank"
                >五道口职业技术学院</a
              >
            </li>
          </ul>
        ...
        <div class="b-foot">
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：XXXXXXXX(日本) XXXXXXXX(韩国)</span>
                <span>Email：xmchx@qq.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020课程版权均归MindSchool所有 京ICP备xxxxxxxx号</span>
              </section>
            </section>
          </section>
          ...
          <aside class="fl col-3 tac mt15">
            <section class="gf-tx">
              <span>
                <a
                  href="https://edu-zjm.oss-cn-beijing.aliyuncs.com/Resume/QR%20Code/wx.jpg"
                >
            ...
            <section class="gf-tx">
              <span>
                <a href="https://weibo.com/u/5483300641">
  ...
  methods: {
    ...
    wxLogin() {
      ...
      loginApi.getLoginMemberInfo().then(response => {
        ...
        cookie.set("MindSchool_ucenter", this.loginInfo, {
          domain: "localhost"
        });
      });
    }
