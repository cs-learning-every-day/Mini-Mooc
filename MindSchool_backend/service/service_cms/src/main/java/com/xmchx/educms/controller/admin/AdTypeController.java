package com.xmchx.educms.controller.admin;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.xmchx.commonutils.result.R;
import com.xmchx.educms.service.CmsAdTypeService;
import com.xmchx.educms.entity.CmsAdType;
...
@RestController
@RequestMapping("/educms/admin-cms/ad-type")
@Slf4j
@CrossOrigin
public class AdTypeController {
    ...
    public R getById(@ApiParam(value = "推荐类别ID", required = true) @PathVariable String id) {
        ...
        if (adType != null) {
            return R.success().data("item", adType);
        } else {
            return R.error().message("数据不存在");
        }
    }
